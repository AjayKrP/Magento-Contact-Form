<?php
namespace Literacis\ContactForm\Controller\Adminhtml\Index;
    ...
    public function execute()
    {
        ...
        if (!is_array($empIds) || empty($empIds)) {
            ...
            try {
                ...
                {
                    $emp = $this->_objectManager->get('Literacis\ContactForm\Model\Employee')->load($empId);
        ...
        return $this->resultRedirectFactory->create()->setPath('literacis/*/index');
    }
